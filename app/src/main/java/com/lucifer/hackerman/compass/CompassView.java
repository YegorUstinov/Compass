...
public class CompassView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        outerRingPath.addOval(boundingBox, Path.Direction.CCW);
        ...
        rollArrow.moveTo(center.x - 30, (int) innerBoundingBox.top + 100);
        rollArrow.lineTo(center.x, (int) innerBoundingBox.top + 50);
        rollArrow.moveTo(center.x + 30, innerBoundingBox.top + 100);
        rollArrow.lineTo(center.x, innerBoundingBox.top + 50);
        ...
        for (double i = 0; i < 360; i += increment) {
            ...
            else canvas.drawLine(center.x, (int) boundingBox.top,
